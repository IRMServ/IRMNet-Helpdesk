...
use Helpdesk\Entity\ItemAvaliacaoChamado;
use Zend\View\Model\ViewModel;
use Zend\Paginator\Paginator;
use Zend\Paginator\Adapter\ArrayAdapter;
use Zend\Debug\Debug;

class ItemAvaliacaoChamadoController extends AbstractActionController {
    ...
    public function storeAction() {
        ...
        if ($id) {
            $setor = $this->getEntityManager()->find('Helpdesk\Entity\ItemAvaliacaoChamado', $id);
        ...
        if ($this->getRequest()->isPost()) {
            ...
            if ($form->isValid()) {
                ...
                if (!$data['iditemavaliacaochamado']) {
                ...
                $this->redirect()->toRoute('item-avaliacao-chamado', array('setor' => $setorid));
            }
        }
    ...
    public function deleteAction() {
      ...
      //  $form->setAttribute('action', '/categoria-chamado/store');
        ...
        return array('form' => $form, 'setor' => $setor,'setorid'=>$setorid);
    }
